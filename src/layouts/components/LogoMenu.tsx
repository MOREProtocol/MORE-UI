...
interface LogoMenuProps {
  logo: { src: string; width: number; height: number } | { node: React.ReactNode };
}
...
export const LogoMenu: React.FC<LogoMenuProps> = ({ logo }) => {
  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
      ...
      >
        <MenuItem component={Link} href="/vaults" onClick={handleClose}>
          Vaults
        </MenuItem>
        ...
        <Divider />
        <MenuItem component={Link} href="https://docs.more.markets/terms" onClick={handleClose}>
          Terms
        </MenuItem>
        <MenuItem component={Link} href="https://docs.more.markets/privacy" onClick={handleClose}>
          Privacy
        </MenuItem>
        <MenuItem component={Link} href="https://docs.more.markets/" onClick={handleClose}>
          Docs
        </MenuItem>
        <Box
          sx={{
